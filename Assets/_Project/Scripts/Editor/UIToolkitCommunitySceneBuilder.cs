...
{
    public static class UIToolkitCommunitySceneBuilder
    {
        private const string ScenePath = "Assets/_Project/Scenes/CommunitySceneUIToolkit.unity";
        private const string UXMLPath = "Assets/_Project/UI/Views/CommunityScreen.uxml";
        private const string PanelSettingsPath = "Assets/_Project/UI/PanelSettings.asset";

        [MenuItem("JuegoTCG/✨ UI Toolkit (UXML + USS)/👥 Comunidad UI Toolkit", priority = 24)]
        public static void BuildUIToolkitCommunityScene()
        {
            ...
            // UI Document
            GameObject uiDocGO = new GameObject("UIDocument_CommunityScreen");
            ...
            // Add Controllers
            uiDocGO.AddComponent<UIToolkitCommunityController>();
            ...
            Debug.Log($"<color=gold>[UIToolkit] ¡Escena de Comunidad UI Toolkit generada y abierta con éxito en {ScenePath}!</color>");
        }
    }
}