...
{
    public static class UIToolkitStoreSceneBuilder
    {
        private const string ScenePath = "Assets/_Project/Scenes/StoreSceneUIToolkit.unity";
        private const string UXMLPath = "Assets/_Project/UI/Views/StoreScreen.uxml";
        private const string PanelSettingsPath = "Assets/_Project/UI/PanelSettings.asset";

        [MenuItem("JuegoTCG/✨ UI Toolkit (UXML + USS)/🏪 Tienda UI Toolkit", priority = 23)]
        public static void BuildUIToolkitStoreScene()
        {
            ...
            // UI Document
            GameObject uiDocGO = new GameObject("UIDocument_StoreScreen");
            ...
            // Add Controller
            uiDocGO.AddComponent<UIToolkitStoreController>();
            ...
            Debug.Log($"<color=gold>[UIToolkit] ¡Escena de Tienda UI Toolkit generada y abierta con éxito en {ScenePath}!</color>");
        }
    }
}
