...
{
    public static class UIToolkitMyCardsSceneBuilder
    {
        private const string ScenePath = "Assets/_Project/Scenes/MyCardsSceneUIToolkit.unity";
        private const string UXMLPath = "Assets/_Project/UI/Views/MyCardsScreen.uxml";
        ...
        public static void BuildUIToolkitMyCardsScene()
        {
            ...
            // UI Document
            GameObject uiDocGO = new GameObject("UIDocument_MyCardsScreen");
            ...
            // Add Controller
            uiDocGO.AddComponent<UIToolkitMyCardsController>();
            ...
            Debug.Log($"<color=gold>[UIToolkit] ¡Escena de Mis Cartas UI Toolkit generada y abierta con éxito en {ScenePath}!</color>");
        }
    }
}
